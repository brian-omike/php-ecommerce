        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="<?php echo $item['item_image'] ?? "../DUKANI/assets/products/1.png" ?>" style="height: 120px;" alt="carti" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-rale font-size-14">21,345 ratings</a>
                        </div>
                        <!-- !product rating -->
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12 font-rale text-success py-3"><i class="fas fa-check"></i>Your order is eligile for FREE Delivery</h6>
